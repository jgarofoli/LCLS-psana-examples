...
class report:
    ...
    def _build_header(self):
        ...
        self.page.h3('CXI Data Summary ' +e.small('CXI01114, Run 37',style='font-family:monospace;')
                ,class_='text-muted',style='color: red;')

        self.page.div.close()

    def _build_jumbotron(self):
        self.page.a('',id='top',class_='anchor')
        self.page.div(class_='jumbotron')
        self.page.h1('CXI01114',style='font-family:monospace;')
        self.page.p('Run 37',class_='lead')
    ...
    def start_subblock(self,title,id=None):
        self.page.h4('Data Time Information')
